...
class pricedown extends StatefulWidget {
  const pricedown({super.key});

  @override
  State<pricedown> createState() => _pricedown();
}

class _pricedown extends State<pricedown> {
